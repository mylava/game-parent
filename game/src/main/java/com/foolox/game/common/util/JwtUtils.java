...
public class JwtUtils {
     ...
     * 签发JWT
     *
     * @param player    登录成功的 player 对象，可以是JSON数据 尽可能少
     * @return String
     */
    ...
    public static Result<Claims> parseJWT(String token, SecretKey key) {
        ...
        try {
            ...
            return Result.error(CodeMessage.LOGIN_TOKEN_EXPIRED);
        } catch (SignatureException e) {
            return Result.error(CodeMessage.LOGIN_TOKEN_INCORRECT);
        } catch (Exception e) {
    ...
    private static SecretKey generalKey(String keyword) {
        ...
        try {
            ...
            e.printStackTrace();
            log.error("JwtUtils generalKey error!");
        }
